...
class Gcompris_computer_simulation:
  ...
  def __init__(self, gcomprisBoard):
    ...
    self.tools = [
      ...
      ["FLIP", "computer/tool-flip.png", "computer/tool-flip_on.png",gcompris.CURSOR_DEFAULT],
      ["FLIP_BACK", "computer/tool-flipback.png", "computer/tool-flipback_on.png",gcompris.CURSOR_DEFAULT]
